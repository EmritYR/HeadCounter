...
app.get(
  ...
  (req, res) => {
    ...
    var sql = SqlString.format(
      "SELECT course.course_id, course.name FROM course JOIN course_lecturer ON course_lecturers.course_id = course.course_id WHERE course_lecturers.lecturer_id = ?",
      [id]
    );
