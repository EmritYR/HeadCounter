...
app.post('/register', passport.authenticate('jwt', {session:false}), (req, res) => {
  ...
  var sql = SqlString.format('INSERT INTO lecturer (lecturer_id, name, password_hash) VALUES (?,?,?)', [id, name, hash]);
...
app.post('/authenticate', (req, res) => {
  ...
  var sql = SqlString.format('SELECT * FROM lecturer WHERE lecturer_id = ?', [id]);
...
app.post('/add-course', passport.authenticate('jwt', {session:false}), (req, res) => {
  const name = req.body.name;
